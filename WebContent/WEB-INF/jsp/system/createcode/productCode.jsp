							...
							<table>
								<tr height="42px;">
									...
									<td><div class="nav-search">
											<input class="nav-search-input" style="width: 186px;"
