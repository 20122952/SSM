				...
				<div class="commitbox">
					<div class="commitbox_inner">
						<div class="commitbox_top">
							<textarea name="USERNAMES" id="USERNAMES" readonly="readonly"
								title="这里不能手动修改"></textarea>
						...
						<td style="margin-top: 0px;">
							<div style="float: left;" style="width:81%">
								<textarea readonly="readonly" name="USERNAME" id="USERNAME"
									rows="1" cols="50" style="width: 595px; height: 32px;"
									title="这里不能手动修改">${pd.username}</textarea>
							</div>
